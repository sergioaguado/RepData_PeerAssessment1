...
This is a data analysis developed by Sergio Aguado as required by the first assignment in the [Reproducible Research course of the Specialization in Data Science by Johns Hopkins University through Coursera][1].
